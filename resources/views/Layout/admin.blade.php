    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="">
                <div class="sidebar-brand-text mx-3">Tea House</div>
            </a>
            ...
            <!-- Heading -->
            <div class="sidebar-heading">Tác vụ</div>
            ...
            <div id="content">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    ...
                                    <div>
                                        <div class="small text-black-500">December 12, 2019</div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h5 class="custom-subtitle mb-0 text-black text-start">@yield('subtitle')</h5>
                    </div>
                    <div>
                        @yield('content')
                    </div>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span style="text-align: center;">Copyright &copy; Tea House 2024</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
